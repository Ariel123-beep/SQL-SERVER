...
insert into Pacientes(Numero_Seguridad_Social, Nombres_Paciente,Apellidos_Paciente,Provincia, Domicilio,Sexo, Num_Historial_Clinico, Codigo_Postal, observaciones)
values(09995644,'Fatima Elizabeth','Campos Lara', 'San Salvador','El Paisnal','Femenino', 23456789,1345, 'mareos constantes');

insert into Pacientes(Numero_Seguridad_Social, Nombres_Paciente,Apellidos_Paciente,Provincia, Domicilio,Sexo, Num_Historial_Clinico, Codigo_Postal, observaciones)
values(09995123,'Manuel Enrique','Ayala Moz', 'San Salvador','San Marcos','Masculino',23434454, 1124, 'estado normal');

insert into Pacientes(Numero_Seguridad_Social, Nombres_Paciente,Apellidos_Paciente,Provincia, Domicilio,Sexo, Num_Historial_Clinico, Codigo_Postal, observaciones)
values(09995789,'Ana Maria','Del Carmen Mendez', 'San salvador','San Marcos','Femenino', 12457890,1545, 'internada por embarazo');
...
insert into Pacientes(Numero_Seguridad_Social, Nombres_Paciente,Apellidos_Paciente,Provincia, Domicilio,Sexo, Num_Historial_Clinico, Codigo_Postal, observaciones)
values(89893435,'Iveth Elizabeth','Orellana Moralez','San Salvador', 'Nejapa','Femenino', 55674423 ,1405 ,'despues de aplicar medicamento su estado es normal');
